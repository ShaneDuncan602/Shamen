...
public class HttpRequestFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws ServletException, IOException {
        ...
        // This was changed from request.getRemoteAddr() to use the X-Forwarded-For-Header to account for the netscaler. If no forwarded for address was found, then default to the remote address. SBD 6-22-15
        ...
        try{
            ...
            StringBuffer logBuffer = new StringBuffer("Processing complete for HTTP request, ").append(isNull(systemTimestamp)).append(", [").append(milliseconds).append(" ms], [").append(isNull(urlString)).append("], [IP Address: ").append(isNull(ipAddress)).append("], [UserId: ").append(isNull(userId)).append("]");
